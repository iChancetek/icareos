...
const features = [
  {
    ...
    example: "Example: A nurse dictating patient notes in English while MediScribe translates and shares in Spanish instantly.",
    color: "#4285F4"
  },
  {
    ...
    example: "Example: A doctor uses MediScribe to translate a consultation for a Spanish-speaking patient in real time.",
    color: "#DB4437"
  },
  {
    ...
    example: "Example: A therapist records a session, receiving an instant, editable transcript.",
    color: "#F4B400"
  },
  {
    ...
    example: "Example: Quickly generate comprehensive patient visit summaries for record-keeping.",
    color: "#0F9D58"
  },
  {
    ...
    example: "Example: “MediScribe, remind me to take my vitamins at 8 AM.”",
    color: "#AB47BC"
  },
  {
    ...
    example: "Example: Converse naturally with MediScribe as if speaking with a trusted assistant.",
    color: "#26A69A"
  },
  {
    ...
    example: "Example: Offering mindfulness exercises during stressful moments.",
    color: "#EC407A"
  },
  {
    ...
    example: "Example: Patient records are securely stored and protected from unauthorized access.",
    color: "#5C6BC0"
  },
  {
    ...
    example: "Example: Start a note on your phone and review it later on your desktop.",
    color: "#78909C"
  }
];
            ...
            <div key={index} className="feature-item-card">
              ...
              <div className="feature-item-content">
                ...
                <div className="feature-item-example">
                  <p><strong>Example:</strong> {feature.example}</p>
                </div>
              </div>
            </div>
          ))}
