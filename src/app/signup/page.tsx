              ...
              <div className="flex gap-2 mb-[-1px]">
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    type="text"
                    required
                    className="relative block w-full appearance-none rounded-none rounded-tl-md px-3 py-2 sm:text-sm"
                ...
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    type="text"
                    required
                    className="relative block w-full appearance-none rounded-none rounded-tr-md px-3 py-2 sm:text-sm"
