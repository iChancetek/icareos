      ...
      <main className="landing-main">
        <section className="hero-section">
          ...
          <p className="hero-subtitle">
            MediScribe is your intelligent, voice-powered companion for healthcare, everyday tasks, and personal interactions—blending empathy, precision, and innovation to revolutionize how you capture, understand, and act on information. With bilingual English–Spanish communication, seamless translation, and precise transcription, MediScribe empowers you to work and connect effortlessly across professional and personal settings.
          </p>
